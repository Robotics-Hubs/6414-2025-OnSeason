...
public final class ArmConstants {
    ...
    public static final ArmHardwareConstants HARDWARE_CONSTANTS =
            switch (Robot.CURRENT_ROBOT) {
                case TEAM_6414_DEVBOT_HYDROXIDE_I -> new ArmHardwareConstants(
                        Centimeters.of(26.0),
                        Kilograms.of(4.0),
                        ...
                        41,
                        false);
                case TEAM_6414_COMPBOT_HYDROXIDE_II -> new ArmHardwareConstants(
                        Centimeters.of(26.0),
                        Kilograms.of(3.0),
                        DCMotor.getKrakenX60(1),
                        44.0 / 16.0 * 15.0,
    ...
    public static final ArmPIDConstants PID_CONSTANTS =
            switch (Robot.CURRENT_ROBOT) {
                case TEAM_6414_DEVBOT_HYDROXIDE_I -> new ArmPIDConstants(
                        0.05,
                        0.3,
                        1.13,
                        0.01,
                        ...
                        Degrees.of(3));
                case TEAM_6414_COMPBOT_HYDROXIDE_II -> new ArmPIDConstants(
                        0.03,
                        0.30,
                        0.79,
                        0.01,
