...
public class SuperStructure {
    ...
    public enum SuperStructurePose {
        // Useful poses
        IDLE(0, Degrees.of(116)),
        INTAKE(0, Degrees.of(126)),
        SCORE_L2(0.16, Degrees.of(106)),
        SCORE_L3(0.54, Degrees.of(106)),
        SCORE_L4(1.111, Degrees.of(70)),
        SCORE_L4_COMPLETE(1.118, Degrees.of(68)),
        RUN_UP(1.111, Degrees.of(55)),
        TRANSFER(0.29, Degrees.of(106)),
