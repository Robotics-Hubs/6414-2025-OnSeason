...
public final class ElevatorConstants {
    ...
    public static final ElevatorHardwareConstants HARDWARE_CONSTANTS =
            switch (Robot.CURRENT_ROBOT) {
                case TEAM_6414_DEVBOT_HYDROXIDE_I -> new ElevatorHardwareConstants(
                        Inches.of(0.25),
                        22,
                        2,
                        84.0 / 12.0,
                        ...
                        31,
                        false);
                case TEAM_6414_COMPBOT_HYDROXIDE_II -> new ElevatorHardwareConstants(
                        Inches.of(0.25),
                        22,
                        2,
                        84.0 / 12.0,
    ...
    public static final ElevatorPIDConstants PID_CONSTANTS =
            switch (Robot.CURRENT_ROBOT) {
                case TEAM_6414_DEVBOT_HYDROXIDE_I -> new ElevatorPIDConstants(
                        0.1,
                        0.80,
                        3.58,
                        0.10,
                        ...
                        Centimeters.of(2));
                case TEAM_6414_COMPBOT_HYDROXIDE_II -> new ElevatorPIDConstants(
                        0.1,
                        0.48,
                        3.58,
                        0.06,
