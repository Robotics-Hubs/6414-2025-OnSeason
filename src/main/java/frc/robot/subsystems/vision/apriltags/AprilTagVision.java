...
public class AprilTagVision extends SubsystemBase {
    ...
    private final RobotMultiTagPoseEstimator multiTagPoseEstimator;
    ...
    public AprilTagVision(AprilTagVisionIO io, List<PhotonCameraProperties> camerasProperties) {
        ...
        this.multiTagPoseEstimator = new RobotMultiTagPoseEstimator(
                fieldLayout, new CameraHeightAndPitchRollAngleFilter(), camerasProperties);
    }

    private Optional<RobotMultiTagPoseEstimator.VisionObservation> result = Optional.empty();
    ...
    private Optional<RobotMultiTagPoseEstimator.VisionObservation> previousResult = Optional.empty();
    ...
    private Pose2d displayVisionPointEstimateResult(Optional<RobotMultiTagPoseEstimator.VisionObservation> result) {
        ...
        Pose2d toReturn = result.orElse(
                        previousResult.orElse(new RobotMultiTagPoseEstimator.VisionObservation(EMPTY_DISPLAY, null, 0)))
                .visionPose();
