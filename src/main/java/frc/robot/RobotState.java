...
import frc.robot.subsystems.vision.apriltags.RobotMultiTagPoseEstimator;
...
public class RobotState {
    ...
    public void addVisionObservation(RobotMultiTagPoseEstimator.VisionObservation observation) {
