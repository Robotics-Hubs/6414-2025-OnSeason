...
import frc.robot.simulation.gamepieces.GamePieceOnFieldSimulation;
import frc.robot.simulation.gamepieces.GamePieceProjectile;
import frc.robot.simulation.motorsims.SimulatedBattery;
import frc.robot.simulation.seasonspecific.crescendo2024.CrescendoNoteOnField;
import frc.robot.simulation.seasonspecific.reefscape2025.Arena2025Reefscape;
...
public abstract class SimulatedArena {
     ...
     * collision space.
     *
     * <p>This method immediately starts the {@link IntakeSimulation.GamePieceContactListener}, which listens for
     ...
     * SmartDashboard/RobotArenaSimulation/Dyn4jEngineCPUTimeMS</code>, usually performance is not a concern
     */
    public synchronized void simulationPeriodic() {
        ...
        synchronized (SimulatedArena.class) {
            ...
            SmartDashboard.putNumber("RobotArenaSimulation/Dyn4jEngineCPUTimeMS", (System.nanoTime() - t0) / 1000000.0);
        }
    }
     ...
     *   <li>For example, {@link CrescendoNoteOnField} has the type "Note".
     * </ul>
     *
