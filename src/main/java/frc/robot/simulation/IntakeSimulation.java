...
import frc.robot.simulation.seasonspecific.reefscape2025.ReefscapeCoralAlgaeStack;
 ...
 *
 * <ul>
 *   <li>1. The type of the game piece ({@link GamePieceOnFieldSimulation#type}) matches {@link #targetedGamePieceType}.
 *   <li>2. The {@link GamePieceOnFieldSimulation} is in contact with the intake (and not other parts of the robot).
