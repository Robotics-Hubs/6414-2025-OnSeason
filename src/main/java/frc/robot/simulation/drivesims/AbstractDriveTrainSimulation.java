...
public abstract class AbstractDriveTrainSimulation extends Body {
     ...
     *
     * <p>Note that the chassis does not appear on the simulation field upon creation. Refer to {@link SimulatedArena}
     * for instructions on how to add it to the simulation world.
     *
