package frc.robot.simulation.gamepieces;
...
import frc.robot.simulation.IntakeSimulation;
 ...
 *
 * <p>For the simulation to actually run, every instance must be added to a {@link SimulatedArena} through
