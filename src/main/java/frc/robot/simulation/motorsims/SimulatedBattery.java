package frc.robot.simulation.motorsims;
...
public class SimulatedBattery {
     ...
     *
     * @param robotMotorSim The motor simulation object.
     */
    public static void addMotor(RobotMotorSim robotMotorSim) {
        electricalAppliances.add(robotMotorSim::getSupplyCurrent);
    }
    ...
    public static void simulationSubTick() {
        ...
        if (Double.isNaN(batteryVoltageVolts)) {
            ...
            DriverStation.reportError(
                    "[RobotSim] Internal Library Error: Calculated battery voltage is invalid"
        ...
        if (batteryVoltageVolts < RoboRioSim.getBrownoutVoltage()) {
            ...
            DriverStation.reportError("[RobotSim] BrownOut Detected, protecting battery voltage...", false);
        }
