...
import static frc.robot.utils.CustomConfigs.RobotInterpolationTable.Variable;
...
import frc.robot.utils.CustomConfigs.RobotInterpolationTable;
import java.util.Optional;
import java.util.concurrent.atomic.AtomicReference;
import java.util.function.Supplier;
import org.littletonrobotics.junction.Logger;

public class RobotShooterOptimization {
    ...
    private final RobotInterpolationTable table;
    private final double minShootingDistance, maxShootingDistance;

    public RobotShooterOptimization(
            String name,
    ...
    private RobotShooterOptimization(String name, RobotInterpolationTable table) {
        this.name = name;
        this.table = table;
    ...
    public static class ChassisAimAtSpeakerDuringAuto extends Command {
        ...
        private final RobotShooterOptimization shooterOptimization;
        ...
        public ChassisAimAtSpeakerDuringAuto(
                ...
                RobotShooterOptimization shooterOptimization) {
