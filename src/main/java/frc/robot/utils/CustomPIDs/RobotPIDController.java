...
public class RobotPIDController extends PIDController {
    private final RobotPIDConfig config;

    public RobotPIDController(RobotPIDConfig config) {
    ...
    public static final class RobotPIDConfig {
