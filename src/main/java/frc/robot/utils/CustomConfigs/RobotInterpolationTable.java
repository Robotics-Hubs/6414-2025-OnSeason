// Original Source:
// https://github.com/Shenzhen-Robotics-Alliance/,
// Copyright 2021-2025 FRC 5516
...
public class RobotInterpolationTable {
    ...
    public RobotInterpolationTable(String name, Variable independentVariable, Variable... interpolatedVariables) {
        this.tableName = name;
