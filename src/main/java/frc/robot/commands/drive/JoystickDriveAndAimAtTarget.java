...
import frc.robot.utils.RobotShooterOptimization;
 ...
 * {@link RobotShooterOptimization} (this is for shooting-on-the-move)
 */
public class JoystickDriveAndAimAtTarget {
    public static Command driveAndAimAtTarget(
            RobotJoystickDriveInput input,
    ...
    public static void execute(
            HolonomicDriveSubsystem driveSubsystem, RobotJoystickDriveInput input, double pilotInputMultiplier) {
